	...
	<div id="control-buttons" class="row" style="text-align: center;">
		...
		<div class="btn-group">
			<button title="Turn on smart house" class="btn btn-default" id="turnon" data-command="TurnOn">
				<span class="glyphicon glyphicon-ok"></span>
			</button>
			<button title="Turn off smart house" class="btn btn-default bfunc prog" id="turnoff" data-command="TurnOff">
		...
		<div class="btn-group">        						
			...
			<button title="Refresh" class="btn btn-default button-down" id="btnRefresh">
